 ...
 * E.g : a "move" {@link model.action.Action} would have a SPACE-like {@link Element} that could be acted upon,
 * whereas an "eat" {@link model.action.Action} would act upon other elements that can be consumed by the give {@link Element}.
