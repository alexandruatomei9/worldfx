...
public class SimpleLegend implements Legend {
	...
	private static final int MIN_SIMPLE_CREATURE_LIFE = 5;
	private static final int MAX_SIMPLE_CREATURE_LIFE = 25;
	private static final int BIRD_LIFE = 15;
	private static final int SIMPLE_CREATURE_TICK = 300;
	private static final int PLANT_TICK = 1000;
	private static final int MIN_PLANT_LIFE = 10;
	private static final int MAX_PLANT_LIFE = 40;
